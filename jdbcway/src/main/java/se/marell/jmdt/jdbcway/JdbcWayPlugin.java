...
public class JdbcWayPlugin implements JmdtCompetitorPlugin {
    private List<? extends AbstractJpaHierarchyWriter> hierarchyWriterCompetitors = Arrays.asList(
            new JdbcWriter(),
            new JdbcBatchWriter());
    private List<? extends AbstractJpaHierarchyReader> hierarchyReaderCompetitors = Arrays.asList(new JdbcReader());
